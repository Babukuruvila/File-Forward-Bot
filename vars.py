...
BOT_TOKEN = environ.get("BOT_TOKEN", "6207520435:AAELfcQgAqB7tiCpBDdb2QHKV3Vbmi8LdvI")
...
TARGET_DB = int(environ.get("TARGET_DB","-1001532592684"))
UPSTREAM_REPO = environ.get("UPSTREAM_REPO", "https://github.com/Babukuruvila/File-Forward-Bot")
